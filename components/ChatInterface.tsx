        ...
        <div className="h-full flex flex-col items-center justify-center p-8 bg-gradient-to-b from-background to-muted/30">
          <div className="max-w-2xl text-center space-y-8 animate-fade-in">
            ...
            <div className="flex items-center justify-center gap-4 pt-4">
              <Badge variant="secondary" className="bg-green-100 text-green-800 border-green-200 text-xs px-3 py-1.5 dark:bg-green-900 dark:text-green-200 dark:border-green-800">
            ...
            {messages.map((message) => (
              ...
              >
                ...
                <div className={`flex-1 space-y-2 ${message.type === 'user' ? 'text-right' : ''}`}>
                  ...
                  <p className="text-xs text-muted-foreground px-2 transition-colors">
                    {message.timestamp}
                  </p>
                </div>
              </div>
