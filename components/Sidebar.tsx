...
export function Sidebar({ 
  ...
  return (
    <div className={`h-full bg-sidebar border-r border-sidebar-border transition-all duration-200 flex flex-col ${
      ...
      <div className="p-4">
        <Button
          onClick={onNewChat}
          variant="outline"
          className="w-full h-10 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 bg-background border-border hover:bg-accent hover:text-accent-foreground text-foreground font-medium"
        >
                    ...
                    >
                      {editingChatId === chat.id ? (
                        <Input
                          ...
                          className="h-7 text-sm px-2 bg-background border-border focus-visible:border-ring rounded-md"
                          autoFocus
                        />
                      ) : (
                      ...
                      <DropdownMenu>
                        ...
                        >
                          ...
                          <DropdownMenuItem
                            ...
                            className="flex items-center gap-2 text-destructive hover:bg-destructive/10 hover:text-destructive cursor-pointer"
                          >
            ...
            <DropdownMenu>
              ...
              >
                ...
                <div className="py-1">
                  <DropdownMenuItem 
                    onClick={onLogout}
                    className="flex items-center gap-3 cursor-pointer px-3 py-2 text-destructive hover:bg-destructive/10 hover:text-destructive"
                  >
