...
export default function App() {
  ...
  const handleCreateBotSuccess = (botData: any) => {
    ...
    // You can add logic here to handle the created bot
    // For example, refresh the chat history or show a notification
  }
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-hidden bg-background">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="dashboard" className="h-full m-0 overflow-auto pb-32">
              <UIView />
            </TabsContent>
          </Tabs>
        </main>
        ...
        >
          <div className="p-6">
            ...
            <div className="max-w-4xl mx-auto mb-4">
              <Button variant="outline" onClick={() => setIsModelSidebarOpen(true)} className="h-10 px-4">
              ...
              <div className="rounded-lg border bg-background shadow-sm">
                <div className="flex items-end gap-3 p-4">
                  <textarea
                    ...
                    className="flex-1 resize-none bg-transparent text-sm placeholder:text-muted-foreground focus:outline-none min-h-[24px] max-h-32 leading-6"
                    rows={1}
                    onKeyDown={(e) => {
                  ...
                  <div className="flex items-center gap-2">
                    {/* Upload Image Button */}
                    <Button type="button" size="icon" variant="ghost" onClick={handleUploadImage}>
